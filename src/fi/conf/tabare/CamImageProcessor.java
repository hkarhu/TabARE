 ...
 * @author irah
 */
public class CamImageProcessor extends JFrame {
...
//					}
	...
	private void track(){
		while(running){
			...
			//Process tripcodes
			while(!unprocessedTripcodes.isEmpty()){
